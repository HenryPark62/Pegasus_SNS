    ...
    while(iter.hasNext()) {
        ...
        if(item.isFormField()) {
            ...
            if (name.equals("image")) {
                ...
                // 서버의 경로 설정 (톰캣 서버의 웹 애플리케이션 경로)
                String root = getServletContext().getRealPath("/images/feed"); // 톰캣의 웹 애플리케이션 경로
                ...
                try {
                    ...
                    feedJson.put("images", new JSONArray().put(ufname)); // 이미지 파일 이름 추가
                    jsonstr = feedJson.toString(); // 업데이트된 JSON 문자열
